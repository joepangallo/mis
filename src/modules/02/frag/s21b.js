  ...
  steps: [
    ...
    },
    {
      ...
      opts: [
        ...
        {t: "&ldquo;It gives us same-day decisions on small loans, built on application and performance data we already hold, and it lowers cost per application while doing it.&rdquo;", ok: true, out: "Right. That reaches strategic value &mdash; helping the business compete better &mdash; while also helping people work smarter and saving money in the process, which is the combination the chapter says a proposal needs to be likely to be funded."},
