  ...
  steps: [
    ...
    },
    {
      ...
      opts: [
        ...
        {t: "Plan for storage space, for computing power, and for a database management system.", ok: true, out: "Right. The storage holds it, the computing power works through it, and the database management system manages and analyzes what is kept. That is the chapter&rsquo;s own list, and the second and third items are the ones people leave out. Processing capacity is what turns a stored record into an answer, and the database software that makes the records searchable is a licence, a configuration and a running cost of its own."},
